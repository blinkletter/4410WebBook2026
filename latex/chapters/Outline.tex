...
9 \& 10 & \textbf{5} & Exploration of Substitution and Rearrangement Mechanisms & Ch. 11 \& literature \\
          &           & \textbf{All topics below can be changed. What do you want?} & \\
11 \& 12 & \textbf{6} & Exploration of Additions and Elimination Mechanisms \& Test \#2 & Ch. 10 \& literature \\
13       & \textbf{7} & Exploration of Pericyclic Reactions & Ch. 15 \& literature \\
...
\textbf{Planned graded assessments are shown in bold.}
...
\textbf{2} & 6 & Sept. 21 & Brønsted Acid/Base Theory and Acidity Functions & Ch. 5.1--5.3 \\
...
(The remainder of the lecture schedule can be continued using the same longtable format.)
...
9 & Meeting 33 & Dec. 4 & First Draft of Literature Exploration & 4\% \\
