...
\begin{quote}
\textbf{Modern Physical Organic Chemistry}\\
\href{https://mitpress.mit.edu/9781891389313/modern-physical-organic-chemistry/}{MIT Press Webpage}
\end{quote}

by Eric V. Anslyn and Dennis A. Dougherty. University Science Books.
...
\item \textbf{Front Matter of Textbook} (PDF). This is the table of contents and the \textbf{preface} from the textbook.

\item \textbf{Appendix 5 Problems} (PDF). I have copied these \textbf{questions from the textbook} and made them available on the Moodle site. Please obtain access to the textbook soon as I won't be able to do this again. Respect copyright---someday you may be an author.
\end{itemize}
...
\href{https://onlinelibrary-wiley-com.proxy.library.upei.ca/doi/book/10.1002/0471648736}{Wiley Online Library}\\
